...
chin_front_cut_height = 2;
chin_side_bite = 360;
chin_side_bite_scale = 0.2;
chin_side_cut_rotation = 6;
chin_side_cut_height = 70;
    ...
    translate([0, 0, jaw_z_shift]) {
        difference() {
            ...
            union() {
                ...
                // Side bite cut
                translate([0, 0, chin_side_cut_height]) {
