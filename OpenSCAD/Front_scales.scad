...
first_scale_rear_width = 130;
first_scale_front_rounding = 40;
first_scale_rear_rounding = first_scale_rear_width/2;
...
second_scale_front_width = 130;
second_scale_rear_height = 98;
second_scale_rear_width = 140;
second_scale_front_rounding = second_scale_front_width/2;
second_scale_rear_rounding = second_scale_rear_width/2;
second_scale_length = 50;
second_scale_x_location = 200;
...
third_scale_front_width = 140;
third_scale_rear_height = 98;
third_scale_rear_width = 140;
third_scale_front_rounding = third_scale_front_width/2;
third_scale_rear_rounding = third_scale_rear_width/2;
