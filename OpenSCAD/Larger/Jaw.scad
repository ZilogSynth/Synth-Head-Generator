...
chin_front_bite = 60; // The amount of width to give the jaw "bite"
...
side_strap_holders_width = 66;
side_strap_holders_location = 170;
side_strap_holders_height = -44;
side_strap_holders_front_cut = 77; // Change this value so that the cut for the side straps are within the walls but not poking through the entire walls of the model
side_strap_holders_rear_cut = 88; // Change this value to compensate for the fact the gap is larger at the back of the jaw
